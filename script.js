            ...
            Plurk:(data)=>{
                ...
                <div class="PlurkDiv">
                    <div>
                        ...
                        <div>
                        【${data.no}】${Ex.func.PlurkDate(data.posted)} / 喜歡：<span class="fav">${data.favorite_count}</span> / 轉噗：<span class="rep">${data.replurkers_count}</span> / <a href="https://www.plurk.com/p/${parseInt(data.plurk_id).toString(36)}" target="_blank">PLURK</a>
            ...
            ClickEvent:(e)=>{
                ...
                switch (e.target.dataset.mode){
                    ...
                    case "Search":
                        ...
                        {
                            document.querySelector("#Progress").innerHTML = Ex.config.msg.time_range_err;
                            document.querySelector(`[data-mode="Search"]`).removeAttribute("disabled");
                            return;
                        }
